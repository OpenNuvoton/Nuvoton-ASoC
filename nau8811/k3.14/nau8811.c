...
static const struct snd_kcontrol_new nau8811_controls[] = {
	...
	SND_SOC_BYTES("DAC BIQ Coefficients", NAU8811_R41_BIQ1_COF1, 20),
	SND_SOC_BYTES("ADC BIQ Coefficients", NAU8811_R21_BIQ0_COF1, 20),
...
{
	struct nau8811 *nau8811 = snd_soc_codec_get_drvdata(w->codec);
	...
	dev_dbg(nau8811->dev, "clk_adc=%d, dmic_clk_threshold = %d, param=%d, val = %d\n",
			       ...
			       struct snd_soc_dai *dai)
{
	...
	struct nau8811 *nau8811 = snd_soc_codec_get_drvdata(codec);
...
static int nau8811_set_sysclk(struct snd_soc_dai *dai, int clk_id,
...
#if 0
static int nau8811_set_sysclk(struct snd_soc_codec *codec, int clk_id,
...
#endif
static const struct snd_soc_codec_driver nau8811_codec_driver = {
...
static int nau8811_i2c_probe(struct i2c_client *i2c, const struct i2c_device_id *id)
{
	...
	ret = snd_soc_register_codec(&i2c->dev,
				     &nau8811_codec_driver, &nau8811_dai, 1);
