/*
 * nau8821.c  --  NAU8821 ALSA Soc Audio driver
 *
...
{
	struct nau8821 *nau8821 = snd_soc_codec_get_drvdata(w->codec);
...
static const struct snd_soc_dai_ops nau8821_dai_ops = {
	...
	.digital_mute = nau8821_digital_mute,
};
 ...
 */
static int nau8821_set_fll(struct snd_soc_codec *codec,
...
static int __maybe_unused nau8821_suspend(struct snd_soc_codec *codec)
{
	...
	nau8821_set_bias_level(codec, SND_SOC_BIAS_OFF);
	...
	struct nau8821 *nau8821)
{
	...
	nau8821->jkdet_enable = of_property_read_bool(dev->of_node,
		"nuvoton,jkdet-enable");
	nau8821->jkdet_pull_enable = of_property_read_bool(dev->of_node,
		"nuvoton,jkdet-pull-enable");
	nau8821->jkdet_pull_up = of_property_read_bool(dev->of_node,
	...
	ret = of_property_read_u32(dev->of_node, "nuvoton,dmic-clk-threshold",
		&nau8821->dmic_clk_threshold);
	if (ret)
	...
	const struct i2c_device_id *id)
{
	...
	ret = snd_soc_register_codec(&i2c->dev,
		&nau8821_codec_driver, &nau8821_dai, 1);
